	...
	{#snippet children({ thumbs })}
		...
		{#each thumbs as thumb (thumb)}
			<SliderPrimitive.Thumb
				...
				index={thumb}
				class="group flex size-8.5 shrink-0 cursor-pointer items-center justify-center rounded-full border border-grey-100 bg-grey-900 ring-yellow-100 transition-[color] focus-visible:text-yellow-100 focus-visible:ring-1 focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50 md:hover:ring-1 dark:bg-white"
			>
